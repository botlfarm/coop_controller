...
char StartLightTime[] = "00:00";
  ...
  digitalWrite(relayPin, LOW);
  Serial.print("Less than 15 minutes of artificial light is needed");Serial.println("");}  //troubleshooting
else if (MinSinceMid>SunriseMin) {   //is the current time is later than sunrise than turn off relay
  digitalWrite(relayPin, LOW);
  Serial.print("It is after sunrise");Serial.println("");}  //troubleshooting
else if (MinSinceMid>=StartLightMin){   //if the current time is later than turn light on time than turn the light on
  digitalWrite(relayPin, HIGH);
  Serial.print("It is before sunrise and the artifical light should be on");Serial.println("");}  //troubleshooting
else {
 digitalWrite(relayPin, LOW); 
 Serial.print("It is before the artifical light needs to turn on");Serial.println("");} //troubleshooting
